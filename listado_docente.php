...
<tr><td>Nro.</td><td>dni_docente</td><td>apellido</td><td>nombre</td><td>correo</td><td>tipo_cat</td><td>operaciones</td><td>operaciones</td></tr>
<?php if(mysqli_num_rows($result)!=0){
    ...
    <td><a href="ver_materias.php?id=<?php echo $data['id']?>">Modificar</a></td>   
    <td><a href="ver_materias.php?id=<?php echo $data['id']?>">Eliminar</a></td>  
    </tr><?php
    $counter ++;
