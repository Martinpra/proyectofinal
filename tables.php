...
{
window.location =
"tables.php?search_text="+document.form1.search_text.value+"&starting="+page;
}
</script>
<?php
...
$qry .=" where nombre like '$searchText%' OR comision like '$searchText%'";
}
else{
$searchText = '';
}
...
$result = $obj->result;
?>
<form name="form1" action="tables.php" method="POST">
...
<tr><td>Nro.</td><td>codigo</td><td>nombre</td><td>comision</td><td>año</td></tr>
